...
# User input example: run static_stack_1.py DR14 496389662
# Use the file matching_thids.txt to find THING_IDs for quasars in DR12 & DR14. DR15 is same as DR14.
