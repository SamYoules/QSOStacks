...
# Author: Sam Youles
# Package: picca
# Name: plot_delta_clip_1.py
# Create plots from stack files, comparing stacks of deltas with deltas of stacks 
# User input example: run plot_delta_clip_1.py DR14 496389662
...
DR = sys.argv[1]
T = sys.argv[2]
a = fits.open('{}stacks_clip/delta-{}.fits.gz'.format(DR, T))
d = a[1].data
...
P.savefig('{}deltas_clip/deltas_{}.png'.format(DR, T))
P.close()
